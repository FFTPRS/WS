...
<section class="mb-16" id="recent-workshops">
    ...
    <div class="text-center mt-12">
        <a href="/pages/workshops/" class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-300 shadow-md hover:shadow-lg">
